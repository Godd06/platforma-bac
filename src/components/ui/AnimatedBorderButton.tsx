...
export const AnimatedBorderButton: React.FC<AnimatedBorderButtonProps> = ({
  ...
  const defaultInner =
    variant === 'pro'
      ? 'bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 border border-amber-500/30 font-bold px-6 py-3 text-xs sm:text-sm'
      : 'bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 font-bold px-6 py-3 text-xs sm:text-sm'
